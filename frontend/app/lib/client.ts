// Code generated by the Encore v1.43.8 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-ikapiar-platform-5bki.encr.app`
}
...
/**
 * Client is an API client for the ikapiar-platform-5bki Encore application.
 */
...
export namespace admin {
    ...
    export class ServiceClient {
        ...
        public async getDashboardData(): Promise<DashboardData> {
            ...
            const resp = await this.baseClient.callAPI("GET", `/admin`)
...
export namespace auth {
    ...
    token: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/login`, undefined, {query})
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "ikapiar-platform-5bki-Generated-TS-Client (Encore/v1.43.8)";
        }
